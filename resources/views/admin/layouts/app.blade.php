...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ request()->routeIs('admin.wali.index') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.wali.index') }}">
            ...
            <li class="nav-item {{ request()->routeIs('admin.biaya.index') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.biaya.index') }}">
                    <i class="fas fa-fw fa-dollar-sign"></i>
                    <span>Biaya</span></a>
            </li>
            <li class="nav-item {{ request()->routeIs('admin.rekening.index') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.rekening.index') }}">
                    <i class="fas fa-fw fa-money-check"></i>
                    <span>Rekening</span></a>
            </li>
            <li class="nav-item {{ request()->routeIs('admin.tagihan.index') ? 'active' : '' }}">
